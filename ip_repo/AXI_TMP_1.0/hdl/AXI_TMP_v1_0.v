...
// Instantiation of Axi Bus Interface S00_AXI
	...
	AXI_TMP_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) AXI_TMP_v1_0_S00_AXI_inst (
	...
	// Add user logic here
	(*DONT_TOUCH= "true"*) wire [num_oscillators*3-1 : 0] w;
    ...
    .input1(w[i*3+1]),
    .output1(w[i*3+2]),
    .output2(input_signal[i])
    );
    (*DONT_TOUCH= "true"*) assign w[i*3] = w[i*3+2]; //nand Control(w[0], w[SIZE-1], rst);
    //assign input_signal[i] = w[i*3];
    end
    endgenerate
        frequency_counter #
