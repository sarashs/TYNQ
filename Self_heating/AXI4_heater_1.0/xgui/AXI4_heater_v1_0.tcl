...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "elements_on" -widget comboBox
...
proc update_PARAM_VALUE.elements_on { PARAM_VALUE.elements_on } {
	# Procedure called to update elements_on when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.elements_on { PARAM_VALUE.elements_on } {
	# Procedure called to validate elements_on
	return true
}
...
proc update_MODELPARAM_VALUE.elements_on { MODELPARAM_VALUE.elements_on PARAM_VALUE.elements_on } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.elements_on}] ${MODELPARAM_VALUE.elements_on}
}
